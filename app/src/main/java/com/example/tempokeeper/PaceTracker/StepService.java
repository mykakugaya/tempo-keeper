 ...
 * Utilizes accelerometer to keep track of step and pace changes
 * */
...
//        Toast.makeText(this, "Pedometer Stopped", Toast.LENGTH_SHORT).show();
    ...
    // Register the StepDetector using SensorManager/accelerometer in onCreate
    ...
    // Unregister the step detector in onDestroy
     ...
     */
    /* IBinder is a base interface for a remotable object
    * We use the interface methods to notify the Running Activity
    * that there has been a pace change
    * */
     ...
     */
    // Listener interface in StepDisplayer
     ...
     * Forwards pace values from PaceNotifier to the activity. 
     */
    // Listener interface in PaceNotifier
